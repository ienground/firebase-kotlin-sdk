...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.auth"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-auth", version.toString())

    pom {
        name = "Firebase Auth KMP"
        description = "Kotlin Multiplatform Firebase Auth Wrapper"
        inceptionYear = "2026"
