...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.storage"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-storage", version.toString())

    pom {
        name = "Firebase Storage KMP"
        description = "Kotlin Multiplatform Firebase Storage Wrapper"
        inceptionYear = "2026"
