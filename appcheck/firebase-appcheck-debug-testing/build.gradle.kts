...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.appcheck.debug.testing"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "FirebaseAppCheckDebugTesting"
            isStatic = true
        }
    }
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            api(libs.firebase.android.appcheck.debug.testing)
        }
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-appcheck-debug-testing", version.toString())

    pom {
        name = "Firebase AppCheck Debug Testing KMP"
        description = "Kotlin Multiplatform Firebase AppCheck Debug Testing Wrapper"
        inceptionYear = "2026"
