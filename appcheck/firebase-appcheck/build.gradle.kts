...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.appcheck"
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            api(libs.firebase.android.appcheck)
        }
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-appcheck", version.toString())

    pom {
        name = "Firebase AppCheck KMP"
        description = "Kotlin Multiplatform Firebase AppCheck Wrapper"
        inceptionYear = "2026"
