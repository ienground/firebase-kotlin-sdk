...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.appcheck.recaptcha"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "FirebaseAppCheckRecaptcha"
            isStatic = true
        }
    }
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            api(libs.firebase.android.appcheck.recaptcha)
        }
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-appcheck-recaptcha", version.toString())

    pom {
        name = "Firebase AppCheck reCAPTCHA KMP"
        description = "Kotlin Multiplatform Firebase AppCheck reCAPTCHA Enterprise/v3 Provider Factory Wrapper"
        inceptionYear = "2026"
