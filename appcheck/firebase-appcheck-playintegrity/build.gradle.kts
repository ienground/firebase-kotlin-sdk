...
kotlin {
    ...
    androidLibrary {
        namespace = "zone.ien.firebase.appcheck.playintegrity"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "FirebaseAppCheckPlayIntegrity"
            isStatic = true
        }
    }
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            api(libs.firebase.android.appcheck.playintegrity)
        }
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates(group.toString(), "firebase-appcheck-playintegrity", version.toString())

    pom {
        name = "Firebase AppCheck Play Integrity KMP"
        description = "Kotlin Multiplatform Firebase AppCheck Play Integrity Provider Factory Wrapper"
        inceptionYear = "2026"
